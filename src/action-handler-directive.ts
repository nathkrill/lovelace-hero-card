...
customElements.define('action-handler-hero-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-hero-card')) {
    return body.querySelector('action-handler-hero-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-hero-card');
