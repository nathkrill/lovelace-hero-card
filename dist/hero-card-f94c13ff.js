 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
var k;C[w]=!0,C.elementProperties=new Map,C.elementStyles=[],C.shadowRootOptions={mode:"open"},null==y||y({ReactiveElement:C}),(null!==(m=f.reactiveElementVersions)&&void 0!==m?m:f.reactiveElementVersions=[]).push("1.6.3");const P=window,A=P.trustedTypes,M=A?A.createPolicy("lit-html",{createHTML:t=>t}):void 0,$=`lit$${(Math.random()+"").slice(9)}$`,x="?"+$,E=`<${x}>`,I=document,S=()=>I.createComment(""),T=t=>null===t||"object"!=typeof t&&"function"!=typeof t,O=Array.isArray,D="[ \t\n\f\r]",R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,F=/-->/g,B=/>/g,H=RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),L=/'/g,N=/"/g,U=/^(?:script|style|textarea|title)$/i,V=(t=>(e,...r)=>({_$litType$:t,strings:e,values:r}))(1),z=Symbol.for("lit-noChange"),j=Symbol.for("lit-nothing"),q=new WeakMap,G=I.createTreeWalker(I,129,null,!1);function W(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==M?M.createHTML(e):e}const Y=(t,e)=>{const r=t.length-1,n=[];let o,i=2===e?"<svg>":"",a=R;for(let e=0;e<r;e++){const r=t[e];let s,c,l=-1,h=0;for(;h<r.length&&(a.lastIndex=h,c=a.exec(r),null!==c);)h=a.lastIndex,a===R?"!--"===c[1]?a=F:void 0!==c[1]?a=B:void 0!==c[2]?(U.test(c[2])&&(o=RegExp("</"+c[2],"g")),a=H):void 0!==c[3]&&(a=H):a===H?">"===c[0]?(a=null!=o?o:R,l=-1):void 0===c[1]?l=-2:(l=a.lastIndex-c[2].length,s=c[1],a=void 0===c[3]?H:'"'===c[3]?N:L):a===N||a===L?a=H:a===F||a===B?a=R:(a=H,o=void 0);const u=a===H&&t[e+1].startsWith("/>")?" ":"";i+=a===R?r+E:l>=0?(n.push(s),r.slice(0,l)+"$lit$"+r.slice(l)+$+u):r+$+(-2===l?(n.push(void 0),e):u)}return[W(t,i+(t[r]||"<?>")+(2===e?"</svg>":"")),n]};class J{constructor({strings:t,_$litType$:e},r){let n;this.parts=[];let o=0,i=0;const a=t.length-1,s=this.parts,[c,l]=Y(t,e);if(this.el=J.createElement(c,r),G.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(n=G.nextNode())&&s.length<a;){if(1===n.nodeType){if(n.hasAttributes()){const t=[];for(const e of n.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith($)){const r=l[i++];if(t.push(e),void 0!==r){const t=n.getAttribute(r.toLowerCase()+"$lit$").split($),e=/([.?@])?(.*)/.exec(r);s.push({type:1,index:o,name:e[2],strings:t,ctor:"."===e[1]?tt:"?"===e[1]?rt:"@"===e[1]?nt:Q})}else s.push({type:6,index:o})}for(const e of t)n.removeAttribute(e)}if(U.test(n.tagName)){const t=n.textContent.split($),e=t.length-1;if(e>0){n.textContent=A?A.emptyScript:"";for(let r=0;r<e;r++)n.append(t[r],S()),G.nextNode(),s.push({type:2,index:++o});n.append(t[e],S())}}}else if(8===n.nodeType)if(n.data===x)s.push({type:2,index:o});else{let t=-1;for(;-1!==(t=n.data.indexOf($,t+1));)s.push({type:7,index:o}),t+=$.length-1}o++}}static createElement(t,e){const r=I.createElement("template");return r.innerHTML=t,r}}function K(t,e,r=t,n){var o,i,a,s;if(e===z)return e;let c=void 0!==n?null===(o=r._$Co)||void 0===o?void 0:o[n]:r._$Cl;const l=T(e)?void 0:e._$litDirective$;return(null==c?void 0:c.constructor)!==l&&(null===(i=null==c?void 0:c._$AO)||void 0===i||i.call(c,!1),void 0===l?c=void 0:(c=new l(t),c._$AT(t,r,n)),void 0!==n?(null!==(a=(s=r)._$Co)&&void 0!==a?a:s._$Co=[])[n]=c:r._$Cl=c),void 0!==c&&(e=K(t,c._$AS(t,e.values),c,n)),e}class X{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:r},parts:n}=this._$AD,o=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:I).importNode(r,!0);G.currentNode=o;let i=G.nextNode(),a=0,s=0,c=n[0];for(;void 0!==c;){if(a===c.index){let e;2===c.type?e=new Z(i,i.nextSibling,this,t):1===c.type?e=new c.ctor(i,c.name,c.strings,this,t):6===c.type&&(e=new ot(i,this,t)),this._$AV.push(e),c=n[++s]}a!==(null==c?void 0:c.index)&&(i=G.nextNode(),a++)}return G.currentNode=I,o}v(t){let e=0;for(const r of this._$AV)void 0!==r&&(void 0!==r.strings?(r._$AI(t,r,e),e+=r.strings.length-2):r._$AI(t[e])),e++}}class Z{constructor(t,e,r,n){var o;this.type=2,this._$AH=j,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=r,this.options=n,this._$Cp=null===(o=null==n?void 0:n.isConnected)||void 0===o||o}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===(null==t?void 0:t.nodeType)&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=K(this,t,e),T(t)?t===j||null==t||""===t?(this._$AH!==j&&this._$AR(),this._$AH=j):t!==this._$AH&&t!==z&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):(t=>O(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]))(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==j&&T(this._$AH)?this._$AA.nextSibling.data=t:this.$(I.createTextNode(t)),this._$AH=t}g(t){var e;const{values:r,_$litType$:n}=t,o="number"==typeof n?this._$AC(t):(void 0===n.el&&(n.el=J.createElement(W(n.h,n.h[0]),this.options)),n);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===o)this._$AH.v(r);else{const t=new X(o,this),e=t.u(this.options);t.v(r),this.$(e),this._$AH=t}}_$AC(t){let e=q.get(t.strings);return void 0===e&&q.set(t.strings,e=new J(t)),e}T(t){O(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let r,n=0;for(const o of t)n===e.length?e.push(r=new Z(this.k(S()),this.k(S()),this,this.options)):r=e[n],r._$AI(o),n++;n<e.length&&(this._$AR(r&&r._$AB.nextSibling,n),e.length=n)}_$AR(t=this._$AA.nextSibling,e){var r;for(null===(r=this._$AP)||void 0===r||r.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cp=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class Q{constructor(t,e,r,n,o){this.type=1,this._$AH=j,this._$AN=void 0,this.element=t,this.name=e,this._$AM=n,this.options=o,r.length>2||""!==r[0]||""!==r[1]?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=j}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,r,n){const o=this.strings;let i=!1;if(void 0===o)t=K(this,t,e,0),i=!T(t)||t!==this._$AH&&t!==z,i&&(this._$AH=t);else{const n=t;let a,s;for(t=o[0],a=0;a<o.length-1;a++)s=K(this,n[r+a],e,a),s===z&&(s=this._$AH[a]),i||(i=!T(s)||s!==this._$AH[a]),s===j?t=j:t!==j&&(t+=(null!=s?s:"")+o[a+1]),this._$AH[a]=s}i&&!n&&this.j(t)}j(t){t===j?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class tt extends Q{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===j?void 0:t}}const et=A?A.emptyScript:"";class rt extends Q{constructor(){super(...arguments),this.type=4}j(t){t&&t!==j?this.element.setAttribute(this.name,et):this.element.removeAttribute(this.name)}}class nt extends Q{constructor(t,e,r,n,o){super(t,e,r,n,o),this.type=5}_$AI(t,e=this){var r;if((t=null!==(r=K(this,t,e,0))&&void 0!==r?r:j)===z)return;const n=this._$AH,o=t===j&&n!==j||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,i=t!==j&&(n===j||o);o&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,r;"function"==typeof this._$AH?this._$AH.call(null!==(r=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==r?r:this.element,t):this._$AH.handleEvent(t)}}class ot{constructor(t,e,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){K(this,t)}}const it=P.litHtmlPolyfillSupport;null==it||it(J,Z),(null!==(k=P.litHtmlVersions)&&void 0!==k?k:P.litHtmlVersions=[]).push("2.8.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kt{static make(t=function(){return Ft}(),e=200/Math.PI*jt(50)/100,r=50,n=2,o=!1){const i=t,a=.401288*i[0]+.650173*i[1]+-.051461*i[2],s=-.250268*i[0]+1.204414*i[1]+.045854*i[2],c=-.002079*i[0]+.048952*i[1]+.953127*i[2],l=.8+n/10,h=l>=.9?xt(.59,.69,10*(l-.9)):xt(.525,.59,10*(l-.8));let u=o?1:l*(1-1/3.6*Math.exp((-e-42)/92));u=u>1?1:u<0?0:u;const d=l,m=[u*(100/a)+1-u,u*(100/s)+1-u,u*(100/c)+1-u],f=1/(5*e+1),p=f*f*f*f,g=1-p,y=p*e+.1*g*g*Math.cbrt(5*e),v=jt(r)/t[1],b=1.48+Math.sqrt(v),_=.725/Math.pow(v,.2),w=_,C=[Math.pow(y*m[0]*a/100,.42),Math.pow(y*m[1]*s/100,.42),Math.pow(y*m[2]*c/100,.42)],k=[400*C[0]/(C[0]+27.13),400*C[1]/(C[1]+27.13),400*C[2]/(C[2]+27.13)];return new Kt(v,(2*k[0]+k[1]+.05*k[2])*_,_,w,h,d,m,y,Math.pow(y,.25),b)}constructor(t,e,r,n,o,i,a,s,c,l){this.n=t,this.aw=e,this.nbb=r,this.ncb=n,this.c=o,this.nc=i,this.rgbD=a,this.fl=s,this.fLRoot=c,this.z=l}}Kt.DEFAULT=Kt.make();
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class me{fromInt(t){return function(t){const e=Gt(Lt(t)),r=Gt(Nt(t)),n=Gt(Ut(t)),o=Dt,i=o[0][0]*e+o[0][1]*r+o[0][2]*n,a=o[1][0]*e+o[1][1]*r+o[1][2]*n,s=o[2][0]*e+o[2][1]*r+o[2][2]*n,c=a/Ft[1],l=s/Ft[2],h=Yt(i/Ft[0]),u=Yt(c);return[116*u-16,500*(h-u),200*(u-Yt(l))]}(t)}toInt(t){return function(t,e,r){const n=Ft,o=(t+16)/116,i=o-r/200,a=Jt(e/500+o),s=Jt(o),c=Jt(i);return Vt(a*n[0],s*n[1],c*n[2])}(t[0],t[1],t[2])}distance(t,e){const r=t[0]-e[0],n=t[1]-e[1],o=t[2]-e[2];return r*r+n*n+o*o}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
...
const Oe={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},De=t=>(...e)=>({_$litDirective$:t,values:e});class Re{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,r){this._$Ct=t,this._$AM=e,this._$Ci=r}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const Fe="ontouchstart"in window||navigator.maxTouchPoints>0||navigator.maxTouchPoints>0;class Be extends HTMLElement{constructor(){super(),this.holdTime=500,this.held=!1,this.ripple=document.createElement("mwc-ripple")}connectedCallback(){Object.assign(this.style,{position:"absolute",width:Fe?"100px":"50px",height:Fe?"100px":"50px",transform:"translate(-50%, -50%)",pointerEvents:"none",zIndex:"999"}),this.appendChild(this.ripple),this.ripple.primary=!0,["touchcancel","mouseout","mouseup","touchmove","mousewheel","wheel","scroll"].forEach((t=>{document.addEventListener(t,(()=>{clearTimeout(this.timer),this.stopAnimation(),this.timer=void 0}),{passive:!0})}))}bind(t,e){if(t.actionHandler)return;t.actionHandler=!0,t.addEventListener("contextmenu",(t=>{const e=t||window.event;return e.preventDefault&&e.preventDefault(),e.stopPropagation&&e.stopPropagation(),e.cancelBubble=!0,e.returnValue=!1,!1}));const r=t=>{let e,r;this.held=!1,t.touches?(e=t.touches[0].pageX,r=t.touches[0].pageY):(e=t.pageX,r=t.pageY),this.timer=window.setTimeout((()=>{this.startAnimation(e,r),this.held=!0}),this.holdTime)},n=r=>{r.preventDefault(),["touchend","touchcancel"].includes(r.type)&&void 0===this.timer||(clearTimeout(this.timer),this.stopAnimation(),this.timer=void 0,this.held?wt(t,"action",{action:"hold"}):e.hasDoubleClick?"click"===r.type&&r.detail<2||!this.dblClickTimeout?this.dblClickTimeout=window.setTimeout((()=>{this.dblClickTimeout=void 0,wt(t,"action",{action:"tap"})}),250):(clearTimeout(this.dblClickTimeout),this.dblClickTimeout=void 0,wt(t,"action",{action:"double_tap"})):wt(t,"action",{action:"tap"}))};t.addEventListener("touchstart",r,{passive:!0}),t.addEventListener("touchend",n),t.addEventListener("touchcancel",n),t.addEventListener("mousedown",r,{passive:!0}),t.addEventListener("click",n),t.addEventListener("keyup",(t=>{13===t.keyCode&&n(t)}))}startAnimation(t,e){Object.assign(this.style,{left:`${t}px`,top:`${e}px`,display:null}),this.ripple.disabled=!1,this.ripple.active=!0,this.ripple.unbounded=!0}stopAnimation(){this.ripple.active=!1,this.ripple.disabled=!0,this.style.display="none"}}customElements.define("action-handler-hero-card",Be);const He=(t,e)=>{const r=(()=>{const t=document.body;if(t.querySelector("action-handler-hero-card"))return t.querySelector("action-handler-hero-card");const e=document.createElement("action-handler-hero-card");return t.appendChild(e),e})();r&&r.bind(t,e)},Le=De(class extends Re{update(t,[e]){return He(t.element,e),z}render(t){}});var Ne={version:"Version",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_error:"Show Error"},Ue={common:Ne},Ve={version:"Versjon",invalid_configuration:"Ikke gyldig konfiguration",show_warning:"Vis advarsel"},ze={common:Ve};const je={en:Object.freeze({__proto__:null,common:Ne,default:Ue}),nb:Object.freeze({__proto__:null,common:Ve,default:ze})};function qe(t,e="",r=""){const n=(localStorage.getItem("selectedLanguage")||"en").replace(/['"]+/g,"").replace("-","_");let o;try{o=t.split(".").reduce(((t,e)=>t[e]),je[n])}catch(e){o=t.split(".").reduce(((t,e)=>t[e]),je.en)}return void 0===o&&(o=t.split(".").reduce(((t,e)=>t[e]),je.en)),""!==e&&""!==r&&(o=o.replace(e,r)),o}console.info(`%c  HERO-CARD \n%c  ${qe("common.version")} 0.1.2    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"hero-card",name:"Hero Card",description:"A template custom card for you to create something awesome"}),function(t="ha-template"){customElements.get(t)||customElements.define(t,Mt)}(),Te();let Ge=class extends ct{static async getConfigElement(){return await import("./editor-dc8d8db9.js"),document.createElement("hero-card-editor")}static getStubConfig(){return{}}setConfig(t){if(!t)throw new Error(qe("common.invalid_configuration"));if(t.entity_image&&!t.entity)throw new Error(qe("common.invalid_configuration"));if(!t.entity_image&&!t.image_url)throw new Error(qe("common.invalid_configuration"));t.test_gui&&function(){var t=document.querySelector("home-assistant");if(t=(t=(t=(t=(t=(t=(t=(t=t&&t.shadowRoot)&&t.querySelector("home-assistant-main"))&&t.shadowRoot)&&t.querySelector("app-drawer-layout partial-panel-resolver"))&&t.shadowRoot||t)&&t.querySelector("ha-panel-lovelace"))&&t.shadowRoot)&&t.querySelector("hui-root")){var e=t.lovelace;return e.current_view=t.___curView,e}return null}().setEditMode(!0),this.config=Object.assign({name:"Hero Card"},t)}shouldUpdate(t){return!!this.config&&function(t,e,r){if(e.has("config")||r)return!0;if(t.config.entity){var n=e.get("hass");return!n||n.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1)}_getImageSource(){return this.config.entity_image?this.entity.attributes.entity_picture||"":this.config.image_url||""}get entity(){const t=this.config.entity||"";return this.hass.states[t]}firstUpdated(t){super.firstUpdated(t);const e=this.renderRoot.querySelector("dynamic-color"),r=this.renderRoot.querySelector("img");if(null===r||null===e)return;new MutationObserver((t=>{for(const r of t)"childList"===r.type||"attributes"===r.type&&"src"===r.attributeName&&(null==e||e.refresh())})).observe(r,{attributes:!0})}render(){return this.config.show_warning?this._showWarning(qe("common.show_warning")):this.config.show_error?this._showError(qe("common.show_error")):V`
    ...
    `}};n([dt({attribute:!1})],Ge.prototype,"hass",void 0),n([mt()],Ge.prototype,"config",void 0),Ge=n([ht("hero-card")],Ge);export{j as A,Ge as H,u as S,z as T,e as _,r as a,n as b,h as c,mt as d,De as e,o as f,wt as g,ht as h,Re as i,yt as l,dt as n,ft as o,ct as s,Oe as t,V as x};
